...
export class StorageService {
   ...
   * @param metadata
   */
  async uploadBytes(path: string, data: Uint8Array | ArrayBuffer, metadata?: UploadMetadata): Promise<UploadResult> {
   ...
   * @param metadata
   */
  uploadBytesResumable(path: string, data: Uint8Array | ArrayBuffer, metadata?: UploadMetadata) {
